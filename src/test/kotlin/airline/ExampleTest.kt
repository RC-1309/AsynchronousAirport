...
class ExampleTest {
    ...
    fun testSimple() {
        ...
        testAndCancel {
            ...
            checkEmails("kbats@itmo.ru", flightId, "1A", "Successfully")
            ...
            checkEmails("kbats@itmo.ru", flightId, "departure time")
    ...
    fun testBooking() {
        ...
        testAndCancel {
            ...
            checkEmails("kbats@itmo.ru", flightId1, "2B", "Successfully")
            ...
            checkEmails("test@example.com", flightId1, "2B", "Unsuccessful")
            Assertions.assertEquals(setOf("1A", "1B", "2A"), booking.freeSeats(flightId1, flightTime))
            ...
            checkEmails("kbats@itmo.ru", flightId1, "Unsuccessful")
            Assertions.assertEquals(setOf("1A", "1B", "2A"), booking.freeSeats(flightId1, flightTime))
            ...
            checkEmails("kbats@itmo.ru", flightId2, "Successfully")
            ...
            sleep()
            checkEmails("test@hello.com", "Unsuccessful")
            ...
            sleep()
            checkEmails("ipetrov@mail.ru", "Unsuccessful")
    ...
    fun testMultipleFlights() {
        ...
        testAndCancel {
            ...
            checkEmails("kbats@itmo.ru", "111", "departure time")
            checkEmails("ipetrov@mail.ru", "222", "departure time")
